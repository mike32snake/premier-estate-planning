...
function ArticleHowItWorks() {
  ...
  return (
    <window.PEPPage current="resources">
      ...
      >
        <P lead>
          Estate planning does not have to drag on. Our process is short, flat-fee, and handled start to finish by the attorney whose name is on the door. Here is what to expect at each step, and what is happening behind the scenes in between.
        </P>
        ...
        <P>
          The decision-making meeting. Together we work through the real choices: beneficiaries, guardians, trust structures, distribution standards, power of attorney, healthcare surrogates, and the dozen smaller decisions that make up a complete plan. You leave with a written summary of every decision we made, and we move into drafting.
        </P>

        <Pull>By the end of plan design, every meaningful decision is made, in plain language and on paper.</Pull>

        <H2>3 · Drafting</H2>
        <P style={{ marginTop: -8, color: T.muted, fontSize: 16, fontStyle: 'italic' }}>Days 5–10 &nbsp;·&nbsp; drafting</P>
        <P>
        ...
        <P style={{ marginTop: -8, color: T.muted, fontSize: 16, fontStyle: 'italic' }}>Day 14 &nbsp;·&nbsp; 90 minutes</P>
        <P>
          A final walk-through of the documents, then signing with two witnesses and a notary. You will leave with your signed originals, a digital copy of your full plan, and a one-page instruction sheet for your personal representative.
        </P>

        <H2>5 · Funding</H2>
        <P style={{ marginTop: -8, color: T.muted, fontSize: 16, fontStyle: 'italic' }}>Days 14 onward &nbsp;·&nbsp; included in the engagement</P>
        <P>
          The plan is signed, but a trust does not own anything until you fund it. Deeds and Certificate of Trust are prepared by our team; beneficiary forms and retitling instructions are sent to your financial institutions. We follow up at thirty, sixty, and ninety days to confirm funding is complete. (For a deeper discussion, see our article on <a href="Funding Your Trust.html" style={{ color: T.teal }}>funding your trust</a>.)
        </P>

        <Callout tone="dark" title="What's included in the flat fee">
          Everything above: the consultation, the design meeting, drafting, one round of revisions, the signing meeting, your signed originals and digital plan, deed preparation for Florida property, and one year of minor amendments. Recording fees and notary fees are paid at cost and listed in the engagement letter.
        </Callout>

        <P>
          To begin, <a href="Contact.html" style={{ color: T.teal }}>schedule a free thirty-minute call</a> or reach us at 813.330.0136.
        </P>
      </window.PEPArticleBody>
